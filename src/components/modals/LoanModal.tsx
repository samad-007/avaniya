    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 bg-[#050505] p-3.5 rounded-lg border border-[#222222]">
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-semibold text-[#D4D4D8] uppercase tracking-wider">
                Interest Rate (% p.a.)
              </label>
            ...
            <div className="sm:col-span-2 flex flex-col gap-1.5 pt-1 border-t border-[#1a1a1a]">
              ...
              <input
                ...
                className="w-full bg-[#111111] border border-[#262626] rounded-lg p-2 text-white text-xs outline-none focus:border-[#555555]"
              />
            </div>
          </div>
          ...
          {/* Action Buttons */}
          <div className="flex items-center justify-between gap-2.5 pt-2.5 border-t border-[#262626]">
            {isEditing && onDelete ? (
              <div>
                {!showDeleteConfirm ? (
                  <button
